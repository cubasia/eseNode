...
exports.validatationErrorMiddleware = exports.validate = void 0;
...
const validatationErrorMiddleware = (error, request, response, next) => {
...
exports.validatationErrorMiddleware = validatationErrorMiddleware;
